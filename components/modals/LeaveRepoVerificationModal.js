...
export default function LeaveRepoVerificationModal({
  repoName,
  onClose,
  onLeave,
  leaveLoading,
  ...
  return (
    ...
    >
      ...
      <div className="flex mt-2 flex-col justify-between w-full items-start">
        ...
        <div className="mt-4 mb-6 space-y-3">
          ...
          <p className="dm-sans-light text-xs lg:text-sm text-black/60 dark:text-white/50">
            This action cannot be undone. This will permanently delete your access to the repository and all the secrets within ${repoName}.
          </p>
      ...
      <div className="flex flex-row gap-3 justify-end">
        ...
        >
          {isLeaving ? "Leaving..." : "Leave Repository"}
        </Button>
      </div>
    </motion.div>
  );
