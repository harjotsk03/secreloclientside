...
export default function RouteDetailsPage() {
  ...
  const { user, authPost, authFetch, loading } = useAuth();
  ...
  const handleAcceptToRepo = async (userAdding) => {
    ...
    console.log("Adding user:", userAdding);
    ...
    for (const secret of secrets) {
      ...
      console.log("Encrypted DEK for secret:", secret.id, encryptDEK);
      keyDEKs.push({
        secret_id: secret.id,
    ...
    console.log("All encrypted DEKs:", keyDEKs);

    // Optional: send them to your backend
    // await api.addUserKeysToSecrets(repoId, userAdding.id, keyDEKs);
  };
  return (
    <>
      <AnimatePresence>
